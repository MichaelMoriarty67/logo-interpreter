...
def logo_output_procedure(exp):
    """Stops the running of a procedure and returns a value."""
    raise classes.OuputException(exp)


def logo_stop_procedure():
    """Stops running of a procedure and returns no value."""
    raise classes.OuputException(None)
